...
**Test coverage (v1.9.13):** 86% overall — covering path security, file CRUD, link auto-update, relative path calculation, search, markdown conversion (HTML↔MD), YAML frontmatter processing, and Zustand store.
