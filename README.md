...
**Test coverage (v1.9.12):** 86% overall — covering path security, file CRUD, link auto-update, relative path calculation, search, markdown conversion (HTML↔MD), YAML frontmatter processing, and Zustand store.
